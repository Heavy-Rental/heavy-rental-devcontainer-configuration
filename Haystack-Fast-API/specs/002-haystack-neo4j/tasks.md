# Tasks: Haystack Neo4j

- [x] T001 Spec Kit package `002-haystack-neo4j`
- [x] T002 Add Neo4j service + volume to docker-compose.yml
- [x] T003 Wire `NEO4J_*` env and depends_on on haystack-fast-api
