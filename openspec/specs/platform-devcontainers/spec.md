...
Cross-pack behavior of the Heavy Rental **local-development** configuration repository: three Compose/Dev Container packs on one external Docker network, with explicit write ownership and HTTP trust boundaries.

This is the OpenSpec **source of truth** for platform-level agreed behavior. Pack capability SoT:

- `Haystack-Fast-API/openspec/specs/haystack-devcontainer/spec.md`
- `Heavy-Rental-REST-API/openspec/specs/rest-api-devcontainer/spec.md`
- `Heavy-Rental-Web-Portal/openspec/specs/web-portal-devcontainer/spec.md`

Change history:

- `openspec/changes/archive/2026-08-20-adopt-openspec-openspdd-adr/`

In-force ADRs: 0001–0010 (see `adr/README.md`).
